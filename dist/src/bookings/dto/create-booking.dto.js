...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: "Booking title" }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: "Booking location" }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        ...
        default: client_1.ApprovalStatus.PENDING,
    }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(client_1.ApprovalStatus),
    __metadata("design:type", String)
], CreateBookingDto.prototype, "approvalStatus", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        description: "Booking status",
        enum: client_1.BookingStatus,
        enumName: "BookingStatus",
        default: client_1.BookingStatus.SCHEDULED,
    }),
    (0, class_validator_1.IsOptional)(),
...
], CreateBookingDto.prototype, "assignedUserIds", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
    ...
    __metadata("design:type", String)
], CreateBookingDto.prototype, "country", void 0);
