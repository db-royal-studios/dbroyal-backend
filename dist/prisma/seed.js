    ...
    const services = [
        {
            ...
            subtitle: "Capturing the magic of your special day with elegance and sophistication",
            description: "Capture your special day with beautiful timeless wedding photography. From intimate ceremonies to grand celebrations, we document every precious moment.",
            packages: [
                {
                    ...
                    pricing: [
                        { country: client_1.Country.NG, price: 950000, currency: "NGN" },
                        { country: client_1.Country.UK, price: 500, currency: "USD" },
                    ],
                },
                {
                    ...
                    pricing: [
                        { country: client_1.Country.NG, price: 1500000, currency: "NGN" },
                        { country: client_1.Country.UK, price: 850, currency: "USD" },
                    ],
                },
                {
                    name: "Luxury Package",
                    ...
                    pricing: [
                        { country: client_1.Country.NG, price: 2200000, currency: "NGN" },
                        { country: client_1.Country.UK, price: 1200, currency: "USD" },
                    ],
                },
            ],
        },
        {
            ...
            description: "Professional event coverage for corporate functions, celebrations, and special occasions. Comprehensive documentation with artistic flair.",
            packages: [
                {
                    ...
                    pricing: [
                        { country: client_1.Country.NG, price: 475000, currency: "NGN" },
                        { country: client_1.Country.UK, price: 250, currency: "USD" },
                    ],
                },
                {
                    ...
                    pricing: [
                        { country: client_1.Country.NG, price: 855000, currency: "NGN" },
                        { country: client_1.Country.UK, price: 550, currency: "USD" },
                    ],
                },
                {
                    name: "Premium Package",
                    ...
                    pricing: [
                        { country: client_1.Country.NG, price: 1420000, currency: "NGN" },
                        { country: client_1.Country.UK, price: 750, currency: "USD" },
                    ],
                },
                {
                    ...
                    pricing: [
                        { country: client_1.Country.NG, price: 2090000, currency: "NGN" },
                        { country: client_1.Country.UK, price: 1100, currency: "USD" },
                    ],
                },
            ],
        },
        {
            ...
            subtitle: "Turning every birthday into a collection of unforgettable frames",
            description: "Capture your special day with beautiful timeless photography. From intimate ceremonies to grand celebrations, we document every precious moment.",
            packages: [
                {
                    name: "Basic Package",
                    slug: "basic-package",
                    ...
                    pricing: [
                        { country: client_1.Country.NG, price: 270000, currency: "NGN" },
                        { country: client_1.Country.UK, price: 150, currency: "USD" },
                    ],
                },
                {
                    name: "Standard Package",
                    ...
                    pricing: [
                        { country: client_1.Country.NG, price: 570000, currency: "NGN" },
                        { country: client_1.Country.UK, price: 300, currency: "USD" },
                    ],
                },
                {
                    name: "Premium Package",
        ...
        },
        {
            ...
            description: "Respectful and dignified photography for burial and memorial events. We capture moments with sensitivity and professionalism.",
            packages: [
                {
                    name: "Basic Package",
                    slug: "basic-package",
                ...
                },
                {
                    ...
                    pricing: [
                        { country: client_1.Country.NG, price: 760000, currency: "NGN" },
                        { country: client_1.Country.UK, price: 400, currency: "USD" },
                    ],
                },
                {
                    name: "Deluxe Package",
                    ...
                    pricing: [
                        { country: client_1.Country.NG, price: 1014000, currency: "NGN" },
                        { country: client_1.Country.UK, price: 600, currency: "USD" },
                    ],
                },
            ],
        },
        {
            ...
            description: "Professional portrait sessions for individuals, families, and professionals looking for stunning headshots.",
            packages: [
                {
                    name: "Basic Package",
                    slug: "basic-package",
                    ...
                    pricing: [
                        { country: client_1.Country.NG, price: 190000, currency: "NGN" },
                        { country: client_1.Country.UK, price: 100, currency: "USD" },
                    ],
                },
                {
                    name: "Standard Package",
                    ...
                    pricing: [
                        { country: client_1.Country.NG, price: 228000, currency: "NGN" },
                        { country: client_1.Country.UK, price: 120, currency: "USD" },
                    ],
                },
            ],
        },
...
async function migrateExistingEvents() {
    ...
    `;
        ...
        for (const event of events) {
            const serviceSlug = OLD_CATEGORY_TO_SERVICE[event.category] || "other-services";
            const fullSlug = event.country === "UK" ? `${serviceSlug}-uk` : serviceSlug;
            const service = await prisma.service.findUnique({
                where: { slug: fullSlug },
            });
            if (!service) {
                console.log(`  ⚠️  Service not found for slug: ${fullSlug}, skipping event ${event.id}`);
                continue;
            }
            await prisma.$executeRaw `
        UPDATE "Event" SET "serviceId" = ${service.id} WHERE id = ${event.id}
      `;
            console.log(`  ✓ Migrated event ${event.id} from ${event.category} to ${service.title}`);
        }
    }
    catch (error) {
